...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/data2/ZYS/yolov5/runs/train/fusion/exp/weights/best.pt', help='model path(s)')
    ...
    parser.add_argument('--project', default='/home/data2/ZYS/yolov5/runs/fusion/val/', help='save to project/name')
